...
const path = {
    ...
    src: {
        html: 'src/formalization-of-order.pug',
        js: 'src/js/common.js',
    ...
    watch: {
        html: 'src/*.pug',
        htmlAll: 'src/**/formalization-of-order.pug',
        js: 'src/js/common.js',
...
gulp.task('build', gulp.parallel('html:build', 'bootstrap:build', 'js:build', 'style:build', 'fonts:build', 'image:build'));
